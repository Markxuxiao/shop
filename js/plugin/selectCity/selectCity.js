...
(function ($) {
	$.fn.extend({
		selectCity:function(options) {
				...
				regionInit(ops.divId);


				/** 
				* @description 选择地区select初始化
				* @param {String} divId 
				* @return 
				*/
				...
				*/
				function getArea(callback){
					if(typeof(nc_a) == 'undefined'){
						...
						area_scripts_src = $("script[src*='selectCity.js']").attr("src");//取JS目录的地址
						area_scripts_src = area_scripts_src.replace('selectCity.js', 'area_array.js');
